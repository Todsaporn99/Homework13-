...
(()=>{
    ...
    var e = {
        ...
        448: (e,n,t)=>{
            ...
            var Ei, Ci = Math.ceil, _i = k.ReactCurrentDispatcher, Pi = k.ReactCurrentOwner, Ni = k.ReactCurrentBatchConfig, zi = 0, Ti = null, Li = null, Mi = 0, Ri = 0, Oi = El(0), Fi = 0, Ii = null, Di = 0, Ui = 0, Ai = 0, ji = null, Vi = null, $i = 0, Bi = 1 / 0, Hi = null, Wi = !1, Qi = null, qi = null, Ki = !1, Yi = null, Xi = 0, Gi = 0, Zi = null, Ji = -1, es = 0;
            function ns() {
    ...
    (()=>{
        ...
        function u(n) {
            var t, r = n.searchText, l = a((0,
            e.useState)({}), 2), o = l[0], u = l[1], i = a((0,
            e.useState)(0), 2), s = i[0], c = i[1];
            return 0 !== Math.ceil(o.total / 10) ? (s > Math.ceil(o.total / 10) && c(Math.ceil(o.total / 10)),
            s < 1 && c(1)) : (s > Math.ceil(o.total / 10) && c(Math.ceil(o.total / 10)),
            0 !== s && c(0)),
            (0,
            e.useEffect)((function() {
                fetch("https://dummyjson.com/products/search?q=".concat(r, "&limit=100")).then((function(e) {
                    return e.json()
                }
                )).then((function(e) {
                    u(e)
            ...
            }, e.createElement("table", null, e.createElement("thead", null, e.createElement("tr", null, e.createElement("th", null, "ID"), e.createElement("th", null, "Name"), e.createElement("th", null, "Price"))), e.createElement("tbody", null, null === (t = o.products) || void 0 === t ? void 0 : t.slice(10 * s - 10, 10 * s).map((function(n) {
                return e.createElement("tr", {
                    key: n.id
                }, e.createElement("td", null, n.id), e.createElement("td", null, n.title), e.createElement("td", null, n.price))
            }
            ...
            }, "prev"), e.createElement("h4", null, s, " of ", Math.ceil(o.total / 10)), e.createElement("button", {
                type: "submit",
                onClick: function() {
                    c(s + 1)
                }
        ...
        n.createRoot(document.getElementById("root")).render(e.createElement(s, null))
    }
    )()
}
)();
